...
-- referenciando a chave fk_trein_exp
alter table treinador add foreign key (fk_trein_exp) 
	references treinador(idtnd);
...
(null, "Barbara oliveira", "11 97643464", "barbara@gmail.com", 12),
(null, "Ana beatriz", "11 976434394", "anab@gmail.com", 13),
(null, "Rodrigo lira", "11 976434744", "rodrigo@gmail.com", 12),
(null, "Denis santos", "11 976434314", "denis@gmail.com", 10);

-- exibir tabela treinador
select * from treinador;

-- exibir os treinadores novatos e seus respectivos treinadores 
select * from treinador as tr_nov 
...
-- inserindo dados na tabela nadador
...
select * from treinador 
	join nadador on fktnd = idtnd 
		where treinador.nome_tnd = "Rafael silva";
-- exibir os nomes dos treinadores e dos respectivos 
-- treinadores experiente
SELECT 
...
FROM
    ...
    -- exibir os dados dos treinadores e dos 
    -- treinadores experiente porem de um determinado treinador
SELECT 
    *
FROM
    treinador AS tr_nov
...
-- exibir os treinadores e seus respectivos nadadores 
-- e os treinadores experiente (orientadores)
select * from treinador as tr_nov join nadador on fktnd = idtnd 
	  join treinador as tr_exp on tr_nov.fk_trein_exp = tr_exp.idtnd;     
                          
                          
-- exibir um determinado treinador pelo nome seu 
-- respectivo nadadores e seu treinador orientador
select * from  treinador as tr_nov join nadador on fktnd = idtnd
	 join treinador as tr_exp on tr_nov.fk_trein_exp = tr_exp.idtnd 
